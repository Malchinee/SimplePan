...
public class AccountController extends ABaseController {
    ...
    public ResponseVO getUseSpace(HttpSession session) {
        SessionWebUserDto userInfoFromSession = getUserInfoFromSession(session);
        UserSpaceDto spaceDto = redisComponent.getUserSpaceUse(userInfoFromSession.getUserId());
    ...
    public ResponseVO updatePassword(HttpSession session,
        ...
        userInfoService.updateUserInfoByUserId(userInfo, userInfoFromSession.getUserId());
        return getSuccessResponseVO(null);
    }
